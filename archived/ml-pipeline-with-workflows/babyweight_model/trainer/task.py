...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help='GCS location for writing checkpoints and exporting '
             'models')
    parser.add_argument(
        '--data-dir',
        type=str,
        required=True,
        help='GCS location where you stored the training data')
    parser.add_argument(
        '--num-train-examples',
        type=int,
        default=100000,
...
def train_and_evaluate(args):
    ...
    training_dataset = model.read_dataset(args.data_dir, 'train', '', args.batch_size)
    validation_dataset = model.read_dataset(args.data_dir, 'eval', '', args.batch_size,
    ...
    export_path = os.path.join(args.job_dir, 'export')
