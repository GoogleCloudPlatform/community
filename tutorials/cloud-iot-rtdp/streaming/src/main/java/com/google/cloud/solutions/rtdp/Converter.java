...
public class Converter {
  ...
  public void startConverter(RtdpOptions options) throws IOException {
    ...
    String DATASET_ID = "iotds";
    String TABLE_NAME = "temp_sensor";
    ...
    try {
      ...
      LOG.debug("Creating dataset : " + DATASET_ID);
    } catch (IOException e) {
      LOG.debug(DATASET_ID + " dataset already exists.");
    }

    TableReference ref = new TableReference();
    ref.setProjectId(PROJECT_ID);
    ref.setDatasetId(DATASET_ID);
    ref.setTableId(TABLE_NAME);
