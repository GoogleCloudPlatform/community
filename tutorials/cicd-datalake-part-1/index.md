...
description: Learn how to set up continuous integration and continuous delivery for data lake data processing pipelines with Terraform, GitHub, and Cloud Build using the popular GitOps methodology.
author: prasadalle
