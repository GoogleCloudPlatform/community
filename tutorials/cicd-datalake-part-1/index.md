...
description: Learn how to set up continuous integration and continuous delivery for a data lake’s data processing pipelines with Terraform, GitHub, and Cloud Build using the popular GitOps methodology.
author: prasadalle
