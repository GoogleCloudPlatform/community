...
tags: logging, stackdriver, gke, fluent-bit, anthos
date_published: 
---
...
Fluent Bit provides similar logs to user logs, but allows you to customize
logs. It can also be used with specific applications or namespaces, as opposed
user logging which affects all applications running on a cluster. 
