...
You should get a response from the redis server: PONG
...
Notice the tryblock with the call to spanBuilder. This illustrates how the program uses OpenCensus to perform tracing. The entire call chain starting with main function is instrumented in this way.
...
After running the program, you’ll navigate the Cloud Trace console under Stackdriver as shown below
