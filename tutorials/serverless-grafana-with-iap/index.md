...
Grafana requires a database for storing user & dashboard data. For this purpose, a CloudSQL instance is created. The password for the database user is placed in Secret Manager, for secured access.
