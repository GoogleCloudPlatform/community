...
Download and install the [Google Cloud Tools for Visual studio extension](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio).[ ](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio) Then, fr[o](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)m[ ](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)V[i](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)s[u](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)a[l](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio) [S](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)t[u](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)d[i](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)o['](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)s[ ](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)t[o](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)p[ ](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)m[e](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio)n[u](https://cloud.google.com/tools/visual-studio/docs/quickstart#install_cloud_tools_for_visual_studio) select **Tools**->**Google Cloud** -> **Publish to Google Cloud**.
