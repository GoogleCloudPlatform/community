...
description: Learn how to configure PostgreSQL to run in Hot Standby mode on Google Cloud Platform. You'll use two Compute Engine instances. One instance will run the primary PostgreSQL server and the other instance will run the standby server.
